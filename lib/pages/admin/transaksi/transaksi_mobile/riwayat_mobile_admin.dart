...
import 'package:ezapps/pages/admin/transaksi/transaksi_mobile/detail_transaksi_mobile_admin.dart';
import 'package:ezapps/service/color.dart';
import 'package:ezapps/service/component.dart';
import 'package:flutter/material.dart';

class TransaksiMobileAdmin extends StatefulWidget {
  @override
  State<TransaksiMobileAdmin> createState() => _TransaksiMobileAdminState();
}

class _TransaksiMobileAdminState extends State<TransaksiMobileAdmin> {
  @override
    ...
    return Scaffold(
      ...
      body: StreamBuilder<QuerySnapshot<Map<String, dynamic>>>(
        stream: FirebaseFirestore.instance
            .collection("layananMobile")
            .orderBy("tglPengajuan", descending: true)
            .snapshots(),
        builder: (context, snapshot) {
          if (snapshot.hasData) {
            var layananMobile = snapshot.data!.docs.map((mobile) {
              return LayananMobile.fromSnapshot(mobile);
            }).toList();
                        ...
                        child: TextButton(
                          ...
                          onPressed: () {
                            Navigator.push(
                              context,
                              SlideTransition1(
                                DetailTransaksiMobileAdmin(mobileService: layananMobile[index], id: id),
                              ),
                            );
                          },
                          child: Row(
